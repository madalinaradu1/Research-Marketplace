...
export default function TagCreateForm(props) {
  ...
  const resetStateValues = () => {
    setTag_id(initialValues.tag_id);
    setDisplay_name(initialValues.display_name);
    setNormalized_name(initialValues.normalized_name);
    setParent_tag_id(initialValues.parent_tag_id);
    setTag_type(initialValues.tag_type);
    setAliases(initialValues.aliases);
    setCurrentAliasesValue("");
    setDescription(initialValues.description);
    setHierarchy_path(initialValues.hierarchy_path);
