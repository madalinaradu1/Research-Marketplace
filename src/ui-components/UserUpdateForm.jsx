...
export default function UserUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAcademicYear(cleanValues.academicYear);
    setGpa(cleanValues.gpa);
    setSkills(cleanValues.skills ?? []);
    setCurrentSkillsValue("");
    setResearchInterests(cleanValues.researchInterests ?? []);
    setCurrentResearchInterestsValue("");
    setCareerInterests(cleanValues.careerInterests ?? []);
    setCurrentCareerInterestsValue("");
    setResumeKey(cleanValues.resumeKey);
    setAffiliation(cleanValues.affiliation);
    setProfileComplete(cleanValues.profileComplete);
    setStatus(cleanValues.status);
    setExpectedGraduation(cleanValues.expectedGraduation);
    setAvailability(cleanValues.availability);
    setPersonalStatement(cleanValues.personalStatement);
    setCertificates(cleanValues.certificates ?? []);
    setCurrentCertificatesValue("");
    setApplicationCount(cleanValues.applicationCount);
    setCreatedAt(cleanValues.createdAt);
    setUpdatedAt(cleanValues.updatedAt);
    setCollege(cleanValues.college);
    setClassesTaught(cleanValues.classesTaught ?? []);
    setCurrentClassesTaughtValue("");
    setFacultyResearchInterests(cleanValues.facultyResearchInterests ?? []);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          profileComplete: profileComplete ?? null,
          status: status ?? null,
          ...
          classesTaught: classesTaught ?? null,
          facultyResearchInterests: facultyResearchInterests ?? null,
        };
