    ...
    try {
        ...
        switch (path) {
            ...
            case '/delete-user':
                ...
                console.log('Delete user request received:', { userId, userEmail, body: JSON.stringify(body) });
                
                if (!userId && !userEmail) {
                    console.log('Missing userId or userEmail in request');
                    return {
                        statusCode: 400,
                        headers,
                        body: JSON.stringify({
                ...
                try {
                    ...
                    console.log('Attempting to delete Cognito user with username:', username);
                    console.log('UserPool ID:', 'us-west-2_KuizmjgYE');
                    ...
                    console.log('Sending delete command to Cognito...');
                    const result = await cognitoClient.send(deleteCommand);
